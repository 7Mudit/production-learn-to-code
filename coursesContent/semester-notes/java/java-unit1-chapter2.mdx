...
Dynamic method dispatch is a process where the call to an overridden method is resolved at runtime, rather than compile-time. This is the basis for one of Java's most powerful concepts—runtime polymorphism.
